...
//VCOM_SideBasedMovement- Remove sides from the array below to force that specific AI side to not execute any advance movement code. (I.E. Moving to reinforce allies, being alerted by distant gunshots and etc). AI with this will still react normally in combat.
VCOM_SideBasedMovement = [WEST,EAST,CIVILIAN,RESISTANCE]; //DEFAULT = [WEST,EAST,CIVILIAN,RESISTANCE];
...
VCOM_SideBasedExecution = [WEST,EAST,CIVILIAN,RESISTANCE]; //DEFAULT = [WEST,EAST,CIVILIAN,RESISTANCE];
