private ["_Unit", "_nBuilding", "_GrabVariable", "_bposleft", "_pcnt", "_LocationArray", "_Array1", "_Pushback1", "_group_array", "_CurrentPos", "_rnd", "_dist", "_dir", "_positions", "_waypoint0", "_AttackPoint", "_PortLocationArray", "_randomarray", "_randomposition", "_KeepLooping"];
//Created on ???
// Modified on :8/15/14 - 8/3/15
...
_Unit setVariable ["VCOM_GARRISONED",true,false];
...
_KeepLooping = 1;
while {_KeepLooping isEqualTo 1;} do {
_GrabVariable = _Unit getVariable "VCOM_GARRISONED";
if (_GrabVariable) exitWith {_KeepLooping = 0;};
