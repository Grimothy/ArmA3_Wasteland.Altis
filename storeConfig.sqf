...
[
	...
	["Police Tactical Vest", "V_TacVest_blk_POLICE", -1, "vest"],
...
[
	...
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 165000, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 168000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 230000, "vehicle"]
	//["MQ4A Greyhawk ATGM UAV", "B_UAV_02_F", 260000, "vehicle"],
	...
	//["K40 Ababil-3 ATGM UAV (CSAT)", "O_UAV_02_F", 260000, "vehicle"],
	//["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 250000, "vehicle"],
	//["K40 Ababil-3 ATGM UAV (AAF)", "I_UAV_02_F", 260000, "vehicle"],
...
[
	["CAS Radio", "radio", localize "STR_WL_ShopDescriptions_Energy_Drink", "client\icons\radio.paa", 10000, 500],
